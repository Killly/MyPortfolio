...
<body>
  <header>
    ...
    <div id="about">
      ...
      <a href="#" onclick="slowScroll('#faq')" title="Ответы на вопросы">Важная информация</a>
		  ...
		  <a href='index.php'  id='log' title='Главная'>Главная</a>
  ...
  <div id="top">
    <?php
    echo '<div style="color:white;font-size:0.7em;text-align:center;">Вы успешно зарегистрировались. Авторизуйтесь, на нашем сайте</div><hr>'; ?>

    <form  id="form_input" style="text-align:left; font-size: 0.7em; padding-top: 2%;" method="POST">
      <input type="text" id="forma" name="username" placeholder="Имя" value="<?php echo @$data['username'];?>" required>
      <input type="password" name="password" placeholder="Пароль"  required>
      <button type="submit" name="button_log" id="mess_send" class="btn btnreg">Авторизироваться</button><br>
