...
<div id="top"><p style="position:absolute;left: 200px; top:100px;">Співавтор</p>
  <form  id="form_input" style="text-align:left; font-size: 0.4em;margin-top: -20px;"  method="post">
    ...
    <div id="autor" style="font-size: 1.2em;">Прикрепить диссертацию</div>
    ...
    <div id="autor" style="font-size: 1.2em;"> Есть ли соучастники?&nbsp;&nbsp;Да</div>
    ...
    <div id="autor" style="font-size:1.2em;"> Нет</div>
